...
type
  ...
  TServerSocket = class
    ...
    Prans: Array [10241 .. 11240] of Integer; // reserved 10241-11240
...
begin
  ...
  begin
    Logger.Write('O arquivo MonsterList.csv n�o foi encontrado.',
      TLogType.Warnings);
    exit;
  end;
  ...
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo AllMobsInfo.csv n�o foi encontrado.',
      TLogType.Warnings);
    exit;
  end;
  AssignFile(F, Path);
...
begin
  ...
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo Dungeons.csv n�o foi encontrado.',
      TLogType.Warnings);
    exit;
  end;
  AssignFile(DataFile, Path);
      ...
      0: // ursula
        begin
          ...
          begin
            ...
            begin
              Logger.Write(PathMobsInfo + ' n�o foi encontrado.',
                TLogType.Warnings);
              exit;
            end;
            ...
            begin
              Logger.Write(PathMobsPos + ' n�o foi encontrado.',
                TLogType.Warnings);
              exit;
            end;
            ...
            begin
              Logger.Write(PathMobsDropNon + ' n�o foi encontrado.',
                TLogType.Warnings);
              exit;
            end;
            ...
            begin
              Logger.Write(PathMobsDropPrata + ' n�o foi encontrado.',
                TLogType.Warnings);
              exit;
            end;
            ...
            begin
              Logger.Write(PathMobsDropDourada + ' n�o foi encontrado.',
                TLogType.Warnings);
              exit;
            end;
...
begin
  Result := false;
 {
  ...
  PacketDevirMobsSpawn.Equip[0] := 305; // totem de prote��o
  Randomize;
  rand := Random(7);
  ...
  begin
    Self.SendServerMsg
      ('Totem de seguran�a falhou. Contate a administra��o. TServerSocket.OpenDevir:Boolean');
    exit;
  end;
...
begin
  ...
  case OBJID of
    320: //item id do bau das rel�quias
    begin
      newOBJ.Index := NewId;
